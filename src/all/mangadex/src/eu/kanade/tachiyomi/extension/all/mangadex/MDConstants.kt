...
object MDConstants {
    ...
    val contentRatingPrefDefaults = setOf(CONTENT_RATING_PREF_VAL_SAFE, CONTENT_RATING_PREF_VAL_SUGGESTIVE, CONTENT_RATING_PREF_VAL_EROTICA, CONTENT_RATING_PREF_VAL_PORNOGRAPHIC)
